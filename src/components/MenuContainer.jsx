...
import { categ, categories } from "../utils/data";
  ...
  return (
    <section className="w-full my-1" id="menu">
      <div className="w-full flex-col items-center justify-center">
        <p
          className="text-2xl font-semibold capitalize text-headingColor relative before:absolute before:rounded-lg before:content before:w-20 before:h-1 before:-bottom-2 before:left-0
